...
@DynamicInsert
@DynamicUpdate
public class HistoryBrokenLine implements Serializable {
	...
	public HistoryBrokenLine() {
	}

	public HistoryBrokenLine(String recordDate, BigDecimal tds, BigDecimal purifyTds, Double color, Double purifyColor, Double tbdt, Double purifyTbdt, Integer userId) {
