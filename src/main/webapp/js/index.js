﻿(function ($) {
	$.learuntab = {
		...
		init: function () {
			...
			$('#reloadtab').on('click', $.learuntab.refreshTab);
						...
						$.each(childNodes, function (i) {
							...
							if (subchildNodes.length > 0) {
								...
								$.each(subchildNodes, function (i) {
									...
									_html += '<li><a class="menuItem" data-id="' + subrow.F_UrlAddress + '" href="' + subrow.F_UrlAddress + '"><i class="' + subchildNodesrow.F_Icon + '"></i>' + subchildNodesrow.F_FullName + '</a></li>';
								});
								_html += '</ul>';
